...
<a class="btn btn-sm btn-success mb-3" href="<?php echo base_url('admin/dataJabatan/tambah_data') ?>">
        ...
        <tr>
            ...
            <td>
                <center>
                    ...
                    <a onclick="return confirm('Yakin Hapus')"class="btn btn-sm btn-primary" href="<?php echo base_url('admin/dataJabatan/delete_data/'.$j->id_jabatan) ?>"><i class="fas fa-trash"></i></a>
