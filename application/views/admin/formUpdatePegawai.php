<div class="container-flluid">
    ...
    <div class="card" class="width: 60%; margin-bottom: 100px;">
        <div class="card-body">
        ...
        <?php foreach($pegawai as $p): ?>
            <form method="POST" action="<?php echo base_url('admin/dataPegawai/update_data_aksi') ?>" 
                ...
                <div class="form-group">
                    ...
                    <input type='number' name="nik" class='form-control' value="<?php echo $p->id_pegawai ?>" />
                ...
                <div class="form-group">
                    ...
                    <select name='jabatan' class='form-control'>
                        <option value="<?php echo $p->id_pegawai ?>"><?php echo $p->jabatan ?></option>
